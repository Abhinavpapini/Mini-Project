# ============================================================
# SVM + SFFCC (PURE CLEAN vs SOUND REPETITION) — SEP-28K
...
X_soundrep = np.array([
    extract_sffcc(get_audio_path(r))
    for _, r in tqdm(soundrep_df.iterrows(), total=len(soundrep_df), desc="SFFCC soundrep")
])
...
print("\n=== DONE : SFFCC + SVM (PURE CLEAN vs SOUND REPETITION) ===")
