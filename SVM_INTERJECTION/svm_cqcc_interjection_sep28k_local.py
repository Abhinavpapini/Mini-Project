# ============================================================
# SVM + CQCC (PURE Clean vs Interjection) — SEP-28K
...
HOP_LENGTH = 256
BINS_PER_OCTAVE = 24
N_BINS = 144         # Nyquist safe for 8 kHz
...
# ============================================================
# CQCC EXTRACTION (ROBUST + PRE-EMPHASIS)
# ============================================================

print("\n[4] Extracting CQCC features...")
t0 = time.time()
...
print("\n📊 FINAL RESULTS")
print("CQCC + SVM | Clean vs Interjection")
