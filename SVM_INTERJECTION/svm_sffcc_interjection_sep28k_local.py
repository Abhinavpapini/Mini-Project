# ============================================================
# SVM + SFFCC (PURE Clean vs Interjection) — SEP-28K
...
# ============================================================
# SFFCC EXTRACTION (ROBUST + PRE-EMPHASIS)
# ============================================================

print("\n[4] Extracting SFFCC features...")
t0 = time.time()
...
def extract_sffcc(path):
    try:
        ...
        # Spectral smoothing (single-frequency filtering)
...
print("\n📊 FINAL RESULTS")
print("SFFCC + SVM | Clean vs Interjection")
