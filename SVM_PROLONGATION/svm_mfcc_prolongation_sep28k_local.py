# ============================================================
# SVM + MFCC (PURE CLEAN vs NON-PURE Prolongation)
...
X_prolong = np.array([
    extract_mfcc(get_audio_path(r))
    for _, r in tqdm(prolong_df.iterrows(), total=len(prolong_df), desc="MFCC prolong")
])
...
print("\nMFCC + SVM (PURE Clean vs Prolongation)")
