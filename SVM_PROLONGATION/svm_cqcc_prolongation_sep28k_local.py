# ============================================================
# SVM + CQCC (PURE CLEAN vs NON-PURE Prolongation)
...
def extract_cqcc(path):
    ...
    cep = dct(log_CQT, type=2, axis=0, norm="ortho")[:N_CEP]
...
X_prolong = np.array([
    extract_cqcc(get_audio_path(r))
    for _, r in tqdm(prolong_df.iterrows(), total=len(prolong_df), desc="CQCC prolong")
])
