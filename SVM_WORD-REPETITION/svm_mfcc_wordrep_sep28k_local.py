# ============================================================
# SVM + MFCC (PURE CLEAN vs WORD REPETITION — NON-PURE)
...
for _, r in tqdm(clean_df.iterrows(), total=len(clean_df), desc="MFCC Clean"):
    X_clean.append(extract_mfcc(get_audio_path(r)))

for _, r in tqdm(wordrep_df.iterrows(), total=len(wordrep_df), desc="MFCC WordRep"):
    X_word.append(extract_mfcc(get_audio_path(r)))
