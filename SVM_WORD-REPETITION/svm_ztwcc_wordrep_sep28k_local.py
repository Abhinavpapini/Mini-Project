# ============================================================
# SVM + ZTWCC (PURE CLEAN vs WORD REPETITION — NON-PURE)
...
for _, r in tqdm(clean_df.iterrows(), total=len(clean_df), desc="ZTWCC Clean"):
    X_clean.append(extract_ztwcc(get_audio_path(r)))

for _, r in tqdm(wordrep_df.iterrows(), total=len(wordrep_df), desc="ZTWCC WordRep"):
    X_word.append(extract_ztwcc(get_audio_path(r)))
...
print("\nZTWCC + SVM (Clean vs WordRep — NON-PURE)")
